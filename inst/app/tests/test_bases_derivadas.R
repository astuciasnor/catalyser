...
stopifnot(
  ...
  grepl("Base derivada:", html_bases, fixed = TRUE),
  grepl("derivadas-estudio", html_bases, fixed = TRUE),
  grepl('id="teste_bases-base_escolhida"', html_bases, fixed = TRUE),
  grepl("seletor.selectize.enable()", codigo_bases, fixed = TRUE),
  grepl("var seletores = ['%s', '%s', '%s']", codigo_bases, fixed = TRUE),
